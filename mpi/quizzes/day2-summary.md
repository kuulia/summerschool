<!--
SPDX-FileCopyrightText: 2020 CSC - IT Center for Science Ltd. <www.csc.fi>
...
1. Which of the following statements about Collective communication
   are correct?
...
SPDX-Snippet CopyrightText: 2020 EPCC, The University of Edinburgh <https://www.epcc.ed.ac.uk/>
-->

3. What is the outcome of the following code snippet when run with 8
