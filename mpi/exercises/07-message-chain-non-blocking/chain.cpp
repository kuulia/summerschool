...
int main(int argc, char *argv[]) {
    ...
    int sendTag = rank + 1;
        ...
        MPI_Isend(message.data(), numElements, MPI_INT, destination, sendTag, MPI_COMM_WORLD, &sendReq);
        ...
        MPI_Irecv(receiveBuffer.data(), numElements, MPI_INT, source, rank, MPI_COMM_WORLD, &recvReq);
